            ...
            <table class="table table-responsive fs-9">
                <thead>
                    <tr>
                        ...
                        <th colspan="11" class="bg-primary border border-dark text-center"><b>Activation</b></th>
                    </tr>
                    <tr>
                        ...
                        <th class="text-center text-white fw-bolder border border-dark" style="background-color: rgb(75, 0, 128)">Remark</th>
                        <th class="text-center text-white fw-bolder border border-dark" style="background-color: rgb(75, 0, 128)">Released</th>
                        <th class="text-center text-white fw-bolder border border-dark" style="background-color: rgb(75, 0, 128)">Released Date</th>
                        <th class="text-center text-white fw-bolder border border-dark" style="background-color: rgb(75, 0, 128)">Act Status</th>
                        <th class="text-center text-white fw-bolder border border-dark bg-danger">E</th>
                        <th class="text-center text-white fw-bolder border border-dark bg-danger">Cancel</th>
